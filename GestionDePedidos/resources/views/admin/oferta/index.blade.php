...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Ofertas <a href="{{url('/admin/oferta/create')}}"><button class="btn btn-success">Nueva</button></a></h3>
		@include('admin.oferta.search')
	</div>
</div>
				...
				<tr>
					...
					<td>
						<a href="{{URL::action('OfertaController@edit',$of->idoferta)}}"><button class="btn-xs btn-info">Editar</button></a>
                         ...
                         <a href="{{URL::action('OfertaController@estado',$of->idoferta)}}"><button class="btn-xs btn-success">Publicar</button></a>
					</td>
				</tr>
