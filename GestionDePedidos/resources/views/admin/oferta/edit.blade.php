...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::model($oferta,['method'=>'PATCH','route'=>['admin.oferta.update',$oferta->idoferta]])!!}
        {{Form::token()}}
          ...
          <div class="form-group">
            ...
            <input type="text" name="descripcion" class="form-control" value="{{$oferta->descripcionoferta}}" placeholder="Descripción...">
          </div>
